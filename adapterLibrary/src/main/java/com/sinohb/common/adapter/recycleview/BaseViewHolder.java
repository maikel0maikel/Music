...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public static BaseViewHolder buildViewHolder(Context context, View itemView) {
        return new BaseViewHolder(context, itemView);
    }

    public static BaseViewHolder buildViewHolder(Context context, ViewGroup parent, int layoutId) {
