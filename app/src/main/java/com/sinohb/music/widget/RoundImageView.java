...
//        circle.getPaint().setColor(DEFAULT_BACKGROUND_COLOR);
        ...
        mRotateAnimator = ObjectAnimator.ofFloat(this, View.ROTATION, 0f, 360f);
        mRotateAnimator.setDuration(40 * 1000L);
    ...
    public boolean isPlay() {
        return mRotateAnimator != null && mRotateAnimator.isStarted();
    }
     ...
     */
    public void resetOtherDiscAnimation() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (mRotateAnimator != null)
                mRotateAnimator.pause();
        }
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = RoundImageView.this.getWidth();
            final int viewHeight = RoundImageView.this.getHeight();
